...
<div class="layout__banner">
	<div class="banner-hexagon banner-hexagon--1"></div>
	<div class="banner-hexagon banner-hexagon--2"></div>
	<div class="banner-hexagon banner-hexagon--3"></div>
	<div class="banner-hexagon banner-hexagon--4"></div>
	<div class="banner-hexagon banner-hexagon--5"></div>
					...
					<div class="plan__content">
						...
						<div class="plan__features">
							<div class="plan-feature">
								...
								<div class="plan-feature__label">5 administrators</div>
							</div>
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
								<div class="plan-feature__label">150 users</div>
							</div>
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
								<div class="plan-feature__label">5 active challenges</div>
							</div>
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
				...
				<div class="plan js-plan">
					...
					<div class="plan__content">
						...
						<div class="plan__features">
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
								<div class="plan-feature__label">10 administrators</div>
							</div>
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
								<div class="plan-feature__label">500 users</div>
							</div>
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
								<div class="plan-feature__label">10 active challenges</div>
							</div>
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
								<div class="plan-feature__label">Public or private community</div>
				...
				<div class="plan js-plan">
					...
					<div class="plan__content">
						...
						<div class="plan__features">
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
								<div class="plan-feature__label">20 administrators</div>
							</div>
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
								<div class="plan-feature__label">1000 users</div>
							</div>
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
								<div class="plan-feature__label">20 active challenges</div>
							</div>
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
								<div class="plan-feature__label">Public or private community</div>
			...
			<div class="plans-container__enterprise anim--in-bot anim--delay">
				<div class="plan-enterprise">
					...
					<div class="plan-enterprise__content">
						<div class="plan-enterprise__included">Whats included</div>
						<div class="plan-enterprise__features">
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
							...
							<div class="plan-feature">
								<div class="plan-feature__icon"><span class="flat-icon icon--16 icon--tick"></span></div>
								<div class="plan-feature__label">All features</div>
							</div>
						</div>
					</div>
				</div>
